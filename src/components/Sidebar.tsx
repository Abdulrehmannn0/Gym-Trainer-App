    ...
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-white dark:bg-[#09090B] border-b border-zinc-200 dark:border-white/[0.08] text-zinc-900 dark:text-white p-4 sticky top-0 z-50 shadow-sm">
        ...
        <button 
          ...
          className="p-2 rounded-xl text-zinc-500 dark:text-[#A1A1AA] hover:bg-zinc-100 dark:hover:bg-white/10 transition-all"
        >
      ...
      >
          ...
          <div className="flex items-center space-x-3 overflow-hidden">
            ...
            {!isCollapsed && (
              ...
              >
                ...
                <p className="text-[9px] text-[#7C3AED] font-bold uppercase tracking-widest mt-0.5">Train Smart. Live Strong.</p>
              </motion.div>
            )}
          </div>
        ...
        {profile && (
          <div className={`px-4 py-4 border-b border-zinc-200 dark:border-white/[0.08] flex items-center space-x-3 bg-zinc-50 dark:bg-white/[0.02] ${isCollapsed ? 'justify-center px-2' : ''}`}>
              ...
              <button
                ...
                className={`
                  ...
                  ${isActive 
                    ...
                    : 'text-zinc-600 dark:text-[#A1A1AA] hover:text-zinc-950 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-white/[0.05]'
                  }
                  ${isCollapsed ? 'justify-center px-0' : ''}
                `}
                id={`nav-${item.id}`}
              >
                <Icon className={`w-4 h-4 shrink-0 transition-transform group-hover:scale-110 ${isActive ? 'text-white' : 'text-zinc-500 dark:text-[#A1A1AA] group-hover:text-[#7C3AED]'}`} />
                {!isCollapsed ? (
        ...
        <div className={`px-4 py-3 border-t border-zinc-200 dark:border-white/[0.08] flex justify-between gap-1 ${isCollapsed ? 'flex-col items-center py-2 px-1' : ''}`}>
          {[
              ...
              <button
                ...
                className={`p-1.5 rounded-lg border flex items-center justify-center transition-all cursor-pointer ${
                  ...
                  active
                    ...
                    : 'border-transparent text-zinc-500 dark:text-[#A1A1AA] hover:bg-zinc-100 dark:hover:bg-white/[0.04] hover:text-zinc-900 hover:text-white'
                }`}
              >
        ...
        <div className="p-3 border-t border-zinc-200 dark:border-white/[0.08]">
          <button
            onClick={handleLogout}
            className={`w-full flex items-center justify-center space-x-2 py-2.5 bg-zinc-50 dark:bg-white/[0.02] hover:bg-[#EF4444]/15 border border-zinc-200 dark:border-white/[0.06] hover:border-[#EF4444]/30 text-xs font-bold tracking-wider uppercase rounded-xl text-zinc-500 dark:text-[#A1A1AA] hover:text-[#EF4444] transition-all duration-200 cursor-pointer ${
